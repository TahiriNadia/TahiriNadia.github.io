...
## [Metrics for comparing Lateral-Gene transfer networks]({{ site.url }}{{ site.baseurl }}/networks)
...
<img src="{{ site.url }}{{ site.baseurl }}/images/pubpic/workflow_algo.pdf" class="img-responsive" width="100%" style="float: center" />
<div style="text-align: right">
  Source: Marchand, Tahiri, Fard, Tremblay-Savard and Lafond (2025) <br>
</div> 


### Related publications:

- Marchand, B., Tahiri, N., Tremblay-Savard, O., & Lafond, M. (2025). On the Comparison of LGT networks and Tree-based Networks. bioRxiv, 2025-11.
- Marchand, B., Tahiri, N., Fard, S. G., Tremblay-Savard, O., & Lafond, M. (2025). Finding maximum common contractions between phylogenetic networks. Algorithms for Molecular Biology, 20(1), 18.

### FUNDING:

- Natural Sciences and Engineering Research Council of Canada/Fonds de recherche du Québec – Nature et technologies (NSERC/FRQNT) NOVA
