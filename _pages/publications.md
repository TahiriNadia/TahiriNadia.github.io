...
### In Preparation
{% include publist_by_year.html items=site.data.inprepar %}

### Journal Articles
{% include publist_by_year.html items=site.data.publist %}

### Book Chapters
{% include publist_by_year.html items=site.data.booklist %}

### Conference Publications
{% include publist_by_year.html items=site.data.conflist %}
